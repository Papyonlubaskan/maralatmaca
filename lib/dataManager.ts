...
export const loadSettings = async (): Promise<Settings> => {
  ...
  return {
    ...
    site_title: "Maral Atmaca - Yazar",
    site_description: "Yazar Maral Atmaca'nın kişisel web sitesi",
    contact_email: "info@maralatmaca.com",
    social_links: {
      twitter: "",
      instagram: "",
      facebook: ""
    ...
    seo: {
      default_meta_title: "Maral Atmaca - Yazar",
      default_meta_description: "Yazar Maral Atmaca'nın kişisel web sitesi",
      default_keywords: "yazar, kitap, edebiyat, maral atmaca"
    },
    appearance: {},
    features: {}
  } as any;
