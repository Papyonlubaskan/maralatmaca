      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="margin-top: 20px; padding: 15px; background: #fef3c7; border-radius: 8px;">
          <p style="margin: 0; color: #92400e; font-size: 14px;">
            <strong>Not:</strong> Bu mesaj maralatmaca.com web sitesindeki iletişim formu aracılığıyla gönderilmiştir.
          </p>
        </div>
      </div>
    `;
...
Bu mesaj maralatmaca.com web sitesindeki iletişim formu aracılığıyla gönderilmiştir.
    `;
  ...
  async sendNewsletterConfirmation(email: string, unsubscribeToken: string): Promise<boolean> {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="text-align: center; margin-bottom: 30px;">
          <h1 style="color: #ea580c; margin: 0;">Maral Atmaca</h1>
    ...
    return await this.sendEmail({
      to: email,
      subject: 'Newsletter Kaydınız Başarılı - Maral Atmaca',
      html
    });
  }
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="margin-top: 20px; padding: 15px; background: #f9fafb; border-radius: 8px;">
          <p style="margin: 0; color: #6b7280; font-size: 14px;">
            Bu bildirim maralatmaca.com admin paneli tarafından gönderilmiştir.
          </p>
        </div>
      </div>
    `;
