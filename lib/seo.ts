...
const defaultSEO: SEOData = {
  title: 'Maral Atmaca - Yazar & Hikaye Anlatıcı',
  description: 'Maral Atmaca\'nın kitapları, hikayeleri ve yazıları. Türk edebiyatının önemli isimlerinden biri olan yazarın eserlerini keşfedin.',
  keywords: ['Maral Atmaca', 'yazar', 'kitap', 'hikaye', 'edebiyat', 'türk edebiyatı'],
  image: '/images/maral-atmaca-og.jpg',
  url: 'https://maralatmaca.com',
  type: 'website',
  author: 'Maral Atmaca',
  canonical: 'https://maralatmaca.com'
};
...
export function generateMetaTags(seoData: Partial<SEOData> = {}): any {
  ...
  const metaTags = [
    ...
    { property: 'og:site_name', content: 'Maral Atmaca' },
    ...
    { name: 'twitter:creator', content: '@maralatmaca' },
    ...
    { name: 'apple-mobile-web-app-title', content: 'Maral Atmaca' },
  ];
  ...
  return {
    ...
    other: {
      ...
      'apple-mobile-web-app-title': 'Maral Atmaca',
...
export function generateStructuredData(seoData: Partial<SEOData> = {}): any {
  ...
  const baseStructuredData = {
    ...
    url: 'https://maralatmaca.com',
    image: 'https://maralatmaca.com/images/maral-atmaca-profile.jpg',
    sameAs: [
      'https://twitter.com/maralatmaca',
      'https://instagram.com/maralatmaca',
      'https://facebook.com/maralatmaca'
    ],
    worksFor: {
      '@type': 'Organization',
      name: 'Maral Atmaca'
  ...
  if (data.type === 'article') {
    return {
      ...
      publisher: {
        ...
        logo: {
          '@type': 'ImageObject',
          url: 'https://maralatmaca.com/images/logo.png'
        }
      },
      datePublished: data.publishedTime,
      dateModified: data.modifiedTime,
...
export function generateOrganizationStructuredData(): any {
  return {
    ...
    name: 'Maral Atmaca',
    url: 'https://maralatmaca.com',
    logo: 'https://maralatmaca.com/images/logo.png',
    description: 'Türk edebiyatının önemli isimlerinden biri olan yazar ve hikaye anlatıcısı.',
    contactPoint: {
      '@type': 'ContactPoint',
...
export function generateWebsiteStructuredData(): any {
  return {
    ...
    name: 'Maral Atmaca',
    url: 'https://maralatmaca.com',
    description: 'Maral Atmaca\'nın kitapları, hikayeleri ve yazıları.',
    author: {
      '@type': 'Person',
      name: 'Maral Atmaca'
    },
    potentialAction: {
      ...
      target: {
        '@type': 'EntryPoint',
        urlTemplate: 'https://maralatmaca.com/kitaplar?search={search_term_string}'
      },
...
export function generateBookSeriesStructuredData(books: Array<{
  ...
  return {
    ...
    description: 'Maral Atmaca\'nın tüm kitapları ve hikayeleri.',
    author: {
      '@type': 'Person',
      name: 'Maral Atmaca'
    },
...
export function generateReadingListStructuredData(books: Array<{
  ...
  return {
    ...
    '@type': 'ItemList',
    name: 'Maral Atmaca Kitapları',
    description: 'Maral Atmaca\'nın tüm kitapları.',
    numberOfItems: books.length,
