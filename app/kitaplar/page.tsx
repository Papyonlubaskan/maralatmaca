    ...
    try {
      ...
      setBooks([
        ...
        },
        {
          ...
          title: "Saka ve Sanrı",
          slug: "saka-ve-sanri",
          description: "Gerçeklik ile hayal arasındaki ince çizgiyi sorgulayan bir hikaye.",
          cover_image: "https://readdy.ai/api/search-image?query=Psychological%20thriller%20book%20cover&width=400&height=600&seq=book2&orientation=portrait",
          author: "Maral Atmaca",
          category: "Gerilim",
          status: "published"
        }
