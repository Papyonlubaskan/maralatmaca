            ...
            <div className="space-y-8 text-gray-600 dark:text-gray-300">
              <section>
                ...
                <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg">
                  ...
                  <p>Maral Atmaca (Bireysel)</p>
                  <p>Web sitesi: maralatmaca.com</p>
                  <p>E-posta: info@maralatmaca.com</p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mt-4">
                  <ul className="space-y-2">
                    <li><strong>E-posta:</strong> kvkk@maralatmaca.com</li>
              ...
              <section>
                ...
                <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg">
                  <p><strong>Veri Sorumlusu:</strong> Maral Atmaca</p>
                  <p><strong>KVKK İletişim:</strong> kvkk@maralatmaca.com</p>
