        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-16 mb-20">
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-bold text-gray-800 mb-6">Merhaba, Ben Maral</h2>
                <div className="prose prose-lg text-gray-600 leading-relaxed space-y-4">
                  ...
                  <p>
                    ...
                    eserleri Yaralasar, Ötanazi Okulu, Medusa'nın Ölü Kumları, Öyle Bir 
                    Uğradım, Saka ve Sanrı romanlarıdır.
                  </p>
                  <p>
