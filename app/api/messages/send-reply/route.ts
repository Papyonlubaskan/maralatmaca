      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #f97316 0%, #ec4899 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
            <h1 style="color: white; margin: 0; font-size: 28px;">Maral Atmaca</h1>
          ...
          <div style="background: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            ...
            <p style="color: #6b7280; font-size: 14px; line-height: 1.6; margin-top: 30px;">
              Saygılarımla,<br>
              <strong style="color: #f97316;">Maral Atmaca</strong><br>
            ...
            <div style="text-align: center;">
              <p style="color: #9ca3af; font-size: 12px; margin: 10px 0;">
                Bu mail <a href="https://maralatmaca.com" style="color: #f97316; text-decoration: none;">maralatmaca.com</a> üzerinden gönderilmiştir.
              </p>
              <div style="margin-top: 15px;">
                <a href="https://www.instagram.com/maral_atmaca" style="color: #f97316; text-decoration: none; margin: 0 10px;">Instagram</a>
                <a href="https://maralatmaca.com/kitaplar" style="color: #f97316; text-decoration: none; margin: 0 10px;">Kitaplarım</a>
              </div>
            </div>
          </div>
        </div>
