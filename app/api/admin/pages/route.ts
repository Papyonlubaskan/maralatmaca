    ...
    const existingPages = [
      {
        ...
        slug: '',
        content: '',
        meta_title: 'Maral Atmaca - Türk Edebiyatı Yazarı',
        meta_description: 'Yazar Maral Atmaca\'nın resmi web sitesi',
        is_active: true,
      ...
      },
      {
        ...
        slug: 'hakkimda',
        content: '',
        meta_title: 'Hakkımda - Maral Atmaca',
        meta_description: 'Yazar Maral Atmaca hakkında bilgi',
        is_active: true,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
        page_type: 'about'
      },
      {
        ...
        slug: 'iletisim',
        content: '',
        meta_title: 'İletişim - Maral Atmaca',
        meta_description: 'Maral Atmaca ile iletişime geçin',
        is_active: true,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
        page_type: 'contact'
      },
      {
        ...
        slug: 'kitaplar',
        content: '',
        meta_title: 'Kitaplar - Maral Atmaca',
        meta_description: 'Maral Atmaca\'nın tüm kitapları',
        is_active: true,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
        page_type: 'books'
