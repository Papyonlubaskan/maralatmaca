    ...
    try {
      ...
      for (const book of books) {
        ...
        if (!book.description || book.description.length < 120) {
          const authorInfo = 'Yazar Maral Atmaca';
    ...
    const recommendations = [
      {
        ...
        description: 'Maral Atmaca - Türk edebiyatının önemli isimlerinden biri. Romanları ve hikayeleriyle okuyucuları derinden etkiliyor.',
        priority: 'high'
      },
      {
        title: 'Anahtar Kelimeler',
        description: 'Maral Atmaca, Türk yazar, roman, hikaye, edebiyat, kitap, okuma, Türk edebiyatı',
        priority: 'high'
      },
      {
        title: 'Site Başlığı',
        description: 'Maral Atmaca - Yazar | Kitaplar, Romanlar ve Hikayeler',
        priority: 'high'
      },
      {
        title: 'Canonical URL',
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        authorInfo: {
          ...
          description: 'Türk edebiyatının değerli isimlerinden Maral Atmaca, romanları ve hikayeleriyle okuyucuları farklı dünyalara taşıyor. Eserleri, derin psikolojik analizler ve etkileyici anlatımlarıyla dikkat çekiyor.'
        }
      }
    });
  } catch (error) {
