      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-2">
            <a href="https://www.instagram.com/maral_atmaca" target="_blank" rel="noopener noreferrer" 
               className="flex items-center space-x-3 text-gray-600 hover:text-blue-600 transition-colors cursor-pointer">
              <i className="ri-instagram-line"></i>
              <span className="text-sm">Instagram</span>
            </a>
            <a href="https://whatsapp.com/channel/0029VaMQf66GpLHORoiwht2b" target="_blank" rel="noopener noreferrer"
