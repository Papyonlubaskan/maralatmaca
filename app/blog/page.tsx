...
export const metadata: Metadata = {
  title: 'Maral Atmaca Blog - Yazarlık Deneyimleri ve Edebiyat',
  description: 'Yazar Maral Atmaca\'nın kişisel blog sayfası. Yazarlık deneyimleri, edebiyat üzerine düşünceler ve yazım süreci hakkında yazılar.',
  keywords: ['Maral Atmaca blog', 'yazarlık deneyimleri', 'edebiyat yazıları', 'yazım süreci', 'Türk edebiyatı blog'],
  openGraph: {
    title: 'Maral Atmaca Blog - Yazarlık ve Edebiyat',
...
const blogPosts = [
  ...
  {
    id: 3,
    title: 'Yarala Sar Romanının Yazım Süreci',
    excerpt: 'İlk romanım Yarala Sar\'ın nasıl doğduğunu ve yazım sürecindeki deneyimlerimi anlatıyorum.',
    date: '2024-12-28',
    slug: 'yarala-sar-romani-yazim-sureci',
    readTime: '6 dk'
  },
  {
    id: 4,
