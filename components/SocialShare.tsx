...
export function SocialFollow({ className = '' }: SocialFollowProps) {
  const socialLinks = [
    {
      platform: 'Facebook',
      url: 'https://facebook.com/maralatmaca',
      icon: 'ri-facebook-fill',
      color: 'bg-blue-600 hover:bg-blue-700'
    },
    {
      platform: 'Twitter',
      url: 'https://twitter.com/maralatmaca',
      icon: 'ri-twitter-fill',
      color: 'bg-sky-500 hover:bg-sky-600'
    },
    {
      platform: 'Instagram',
      url: 'https://instagram.com/maralatmaca',
      icon: 'ri-instagram-fill',
      color: 'bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600'
    },
    {
      platform: 'LinkedIn',
      url: 'https://linkedin.com/in/maralatmaca',
      icon: 'ri-linkedin-fill',
      color: 'bg-blue-700 hover:bg-blue-800'
    },
    {
      platform: 'YouTube',
      url: 'https://youtube.com/@maralatmaca',
  ...
  return (
    <div className={`${getPlatformStyles()} ${className}`}>
      <div className="flex items-center mb-3">
        ...
        <div>
          <div className="font-semibold text-sm">Maral Atmaca</div>
