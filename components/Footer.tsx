...
export default function Footer() {
  ...
  const [footerSettings, setFooterSettings] = useState({
    site_name: 'Maral Atmaca',
    copyright_text: '2025 Maral Atmaca. Tüm hakları saklıdır.',
    ...
    social_links: {
      instagram: 'https://www.instagram.com/maral_atmaca?igshid=dWJmb3M1cnBrbjM1&utm_source=qr',
      twitter: '',
      facebook: '',
      youtube: '',
      spotify: 'https://open.spotify.com/user/31cxmviybemcerfgxks6cy72xlva?si=9ROLFhJ2Rk2AY3AKwW7hgw',
      whatsapp: 'https://whatsapp.com/channel/0029VaMQf66GpLHORoiwht2b'
    },
    legal_links: [
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-orange-500 to-pink-500 bg-clip-text text-transparent text-2xl italic" style={{fontFamily: 'Times New Roman, serif'}}>
              {footerSettings.site_name || 'Maral Atmaca'}
            </div>
            ...
            <div className="flex justify-center space-x-6">
              ...
              {footerSettings.social_links.spotify && (
                <a href={footerSettings.social_links.spotify} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors">
